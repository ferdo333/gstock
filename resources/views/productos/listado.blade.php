...
<div class="row">
    ...
    <div class="col-3">
       ...
       <div class="card-body">
           ...
           <h5 classs="card-title">Categoria: {{$producto->categoria->nombre}}</h5>
           <h5 classs="card-title">Descripción: {{$producto->desc}}</h5>
           <h5 classs="card-title">Estado: {{$producto->estado}}</h5>
